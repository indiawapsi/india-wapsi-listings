...
export default function PropertyPage() {
  ...
  useEffect(() => {
    async function fetchAds() {
      try {
        const response = await fetch('/api/ads?category=Property%20and%20Housing');
  ...
  return (
    <div className="p-8 ">
      <h1 className="text-3xl font-bold mb-4 text-blue-700">Property and Housing</h1>
      <p className="text-gray-700 mb-6">
        We help NRIs and Overseas Indians buy, sell, or rent property in India safely and remotely. From documentation to trusted brokers . we’ve got you covered.
      </p>
      <div className="mt-8">
        {loading ? (
          <p className="text-black">Loading ads...</p>
        ) : ads.length === 0 ? (
          <p className="text-black">No property ads found.</p>
        ) : (
