  ...
  try {
    ...
    const emailHtml = `
      <div style="max-width:520px;margin:32px auto;padding:32px;background:#f9f9fb;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,0.07);font-family:Segoe UI,Arial,sans-serif;color:#222;">
        <h2 style="color:#b91c1c;font-size:1.7rem;margin-bottom:18px;">Ad Report</h2>
        ${adDetailsHtml}
        <p style="margin:0 0 8px 0;"><strong>Report Reason:</strong></p>
        <div style="background:#fff;border-radius:8px;padding:16px 14px;border:1px solid #e5e7eb;font-size:1.05rem;white-space:pre-line;">${reason}</div>
      </div>
    `;
